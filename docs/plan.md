...
- [x] Two-stage curriculum: exp42 4-phase curriculum (temp 0.05→0.02, LR 2e-5→1e-5→5e-6) + linear interp(0.6) → dense MAP@100=0.2439 (far below 0.3152), fused MAP@100=0.3072 (far below 0.3651). High initial LR (2e-5) + aggressive LR drop to 5e-6 for HN phases hurt badly. OVERFIT/PLATEAU.
